...
// Disable the SoundManager class and export a dummy object
console.log('SoundManager disabled - using new AudioService')
export const soundManager = {
  init: () => console.log('SoundManager init skipped'),
  playSound: () => console.log('SoundManager playSound skipped'),
  playMusic: () => console.log('SoundManager playMusic skipped'),
  stopMusic: () => console.log('SoundManager stopMusic skipped'),
  stopAll: () => console.log('SoundManager stopAll skipped'),
...
//       await Promise.all([
//         this.loadMusic('titleMusic', '/sounds/glass-and-buffalo-warrior-travel.mp3')
//           .then(updateProgress),
//         this.loadMusic('readyMusic', '/sounds/ready.wav')
//           .then(updateProgress),
//         this.loadMusic('gameMusic', '/sounds/glass-and-buffalo-warrior-travel.mp3')
//           .then(updateProgress),
